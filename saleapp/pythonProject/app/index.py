from flask import render_template # Khai báo thư viện, đổ cái template vào
import dao
from app import app
...
def index():      # Khi có yêu cầu nào gửi lên đường dẫn gốc, Flask sẽ gọi hàm index
    cates= dao.load_catagories() #Gọi hàm load_catagories trong thư mục py và gán dữ liệu cho nó
